...
struct _GaimBuddy {
  ...
  /* ///GaimBuddyIcon*/void *icon;                    /**< The buddy icon. */
 ...
 */
  void gaim_buddy_set_icon(GaimBuddy *buddy, /*GaimBuddyIcon/// */void *icon);
 ...
 */
  /*GaimBuddyIcon/// */ void *gaim_buddy_get_icon(const GaimBuddy *buddy);
